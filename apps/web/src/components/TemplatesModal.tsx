  ...
  // ── Sales ──────────────────────────────────────────────────────────────────
  {
    ...
    graph: {
      ...
      nodes: [
        ...
        { id: 'check_score', type: 'condition', config: { field: 'score', equals: '' } },
  ...
  },
  {
    ...
    graph: {
      ...
      nodes: [
        ...
        { id: 'gate', type: 'condition', config: { field: 'id', operator: 'exists' } },
  ...
  },
  {
    ...
    graph: {
      ...
      nodes: [
        ...
        { id: 'check_threshold', type: 'condition', config: { field: 'value', operator: 'gt', value: '{{input.threshold}}', source: '{{fetch_metrics}}' } },
  ...
  },
  {
    ...
    graph: {
      ...
      nodes: [
        ...
        { id: 'extract_vec', type: 'extract', config: { source: '{{embed_query}}', path: 'data.0.embedding' } },
        { id: 'search_pinecone', type: 'pinecone', config: { api_key: '{{credential.pinecone_key}}', index_host: '{{credential.pinecone_host}}', operation: 'query', vector: '{{extract_vec.value}}', top: 5, namespace: '{{input.namespace}}' } },
        ...
        { id: 'result', type: 'transform', config: { template: { answer: '{{answer.content}}', question: '{{input.question}}', sources_count: '{{search_pinecone.body.matches.length}}' } } },
      ],
      edges: [
  ...
  },
  {
    ...
    graph: {
      ...
      nodes: [
        ...
        { id: 'check_count', type: 'condition', config: { field: 'count', operator: 'gt', value: '0', source: '{{fetch_articles}}' } },
      ...
      edges: [
        ...
        { source: 'check_count', target: 'embed_articles', condition_label: 'true' },
