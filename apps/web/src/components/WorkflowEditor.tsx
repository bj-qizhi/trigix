...
const NODE_TYPE_LIST: { type: NodeType; label: string; color: string; icon: string; desc: string; category: string }[] = [
  ...
  { type: 'ftp',          label: 'FTP',           color: 'var(--node-awss3)',        icon: '📁',  desc: 'Plain FTP file transfer. Config: host, port, username, password, operation (list/download/upload/delete), path, content (base64). Returns file list or base64 content.', category: 'Integration' },
  { type: 'sftp',         label: 'SFTP',          color: 'var(--node-awss3)',        icon: '🔐',  desc: 'SFTP over SSH (pure-Rust, password auth). Config: host, port, username, password, operation (list/download/upload/delete), path, content (base64).', category: 'Integration' },
  { type: 'ssh',          label: 'SSH',           color: 'var(--node-code)',         icon: '🖥️',  desc: 'Run a command over SSH (password auth). Config: host, port, username, password, command. Returns {stdout, stderr, exit_status}.', category: 'Integration' },
